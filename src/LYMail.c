...
/*
 * Patch for 2.8.1 development release applied to 2.8 sources by
 * Joel Klecker <jk@espy.org> for Debian GNU/Linux.
 * (the only failure was the hunk with the comment at the top of the file)
 */
